-- Incremental seed / repair script (non-destructive)
-- Safe for existing environments: no DROP/TRUNCATE/DELETE.
USE flash_sale;

SET NAMES utf8mb4;

-- Default password for newly inserted users is 123456 (PBKDF2_SHA256)
